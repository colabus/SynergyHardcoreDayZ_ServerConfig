#include "$CurrentDir:\\mpmissions\\regular.namalsk\\CustomObjects\\SpawnObject.c"
#include "$CurrentDir:\\mpmissions\\regular.namalsk\\CustomObjects\\CustomAreas.c"
...
class CustomMission: MissionServer
{
	override void OnInit()
	{
		...
		if ( m_EventManagerServer )
		{
			...
			m_EventManagerServer.OnInitServer( true, 550, 600, 2 );
